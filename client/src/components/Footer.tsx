...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden bg-gradient-to-br from-gray-800 via-gray-900 to-gray-800 text-white z-10 w-full">
      ...
      <div className="relative py-8 sm:py-12 px-4 sm:px-6 pb-0">
